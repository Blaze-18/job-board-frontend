...
let {data: jobCategories} = await useFetch('https://blazeforyou.pythonanywhere.com/api/v1/jobs/categories')
...
let {data: jobs} = await useFetch('https://blazeforyou.pythonanywhere.com/api/v1/jobs/', {
